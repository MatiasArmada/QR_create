...
# Abrir el logo
logo = Image.open('Sancor-Seguros logo.png')
...
img.save("Figma_with_logo_and_border.png")
...
"""
import qrcode
img = qrcode.make("https://www.figma.com/proto/X0iV0raNGN3RJQCoYf9Az3/Sancor---AP-Form?node-id=1-205&t=zq0mguDAKfVCwfC6-0&scaling=scale-down&content-scaling=fixed&page-id=0%3A1")
f = open("Figma.png", "wb")
img.save(f)
f.close()
"""